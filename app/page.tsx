              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <div className="relative">
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
                    <Car className="h-4 w-4 md:h-5 md:w-5 text-gray-400" />
                  </div>
                  <select
                    value={modelYear}
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-2">50,000+</div>
              <div className="text-blue-100 text-sm md:text-base">Değerlenen Araç</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-2">95%</div>
              <div className="text-blue-100 text-sm md:text-base">Müşteri Memnuniyeti</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-2">24/7</div>
              <div className="text-blue-100 text-sm md:text-base">Destek Hizmeti</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold mb-2">₺2M+</div>
              <div className="text-blue-100 text-sm md:text-base">Toplam İşlem Hacmi</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-6 md:gap-8">
            <div>
              <div className="flex items-center mb-4">
                <Car className="h-5 w-5 md:h-6 md:w-6 text-blue-400 mr-2" />
                <span className="text-2xl md:text-4xl font-bold">aracteklifi.com</span>
              </div>
            ...
            <div>
              <h3 className="text-base md:text-lg font-semibold mb-4">Hizmetler</h3>
            ...
            <div>
              <h3 className="text-base md:text-lg font-semibold mb-4">Şirket</h3>
              <ul className="space-y-2 text-gray-400 text-sm md:text-base">
            ...
            <div>
              <h3 className="text-base md:text-lg font-semibold mb-4">İletişim</h3>
