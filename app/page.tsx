...
import { getCarBrands, getAvailableYears } from "@/lib/car-valuation";
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setYears(yearsData.length > 0 ? yearsData : generateYears());
      } catch (error) {
  ...
  const features = [
    {
      ...
      description: "5 dakika içinde aracınızın detaylı değerleme raporunu alın",
      color: "text-blue-500"
    },
    {
      icon: Shield,
      title: "Güvenilir Sonuçlar",
      description: "Piyasa verilerine dayalı %95 doğruluk oranı ile değerleme",
      color: "text-green-500"
    },
    {
      icon: Clock,
      title: "7/24 Hizmet",
      description: "İstediğiniz zaman araç değerleme hizmetimizden yararlanın",
      color: "text-purple-500"
    }
  ];

  const stats = [
    { number: "50,000+", label: "Değerlenen Araç", icon: Car },
    { number: "95%", label: "Müşteri Memnuniyeti", icon: Star },
    { number: "24/7", label: "Destek Hizmeti", icon: Clock },
    { number: "₺2M+", label: "Toplam İşlem Hacmi", icon: DollarSign }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "Marka, model, yıl ve diğer detayları kolayca girin",
      icon: Car
    },
    {
      step: "2",
      title: "Anında Değerleme",
      description: "Yapay zeka destekli sistem ile anında değerleme yapılır",
      icon: Calculator
    },
    {
      step: "3",
      title: "Detaylı Rapor Alın",
      description: "Piyasa analizi ve satış önerileri ile birlikte raporunuzu alın",
      icon: BarChart3
    }
  ];
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 order-1 lg:order-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-lg font-bold text-lg transition-colors bg-blue-600 text-white hover:bg-blue-700 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed"
                >
                  ÜCRETSİZ TEKLİF AL
                </button>
              </form>
              ...
              <div className="mt-6 text-center">
                <p className="text-xs text-gray-500">Güvenli ve hızlı değerleme süreci</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Neden aracteklifi.com?</h2>
            <p className="text-lg text-gray-600">Binlerce kullanıcının güvendiği araç değerleme platformu</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center p-6">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-${feature.color.replace('text-', '')}-100`}>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">3 basit adımda aracınızın değerini öğrenin</p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link href="/arac-degerle" className="hover:text-white transition-colors">
                    Araç Değerleme
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>© 2024 aracteklifi.com. Tüm hakları saklıdır.</p>
          </div>
        </div>
      </footer>
    </div>
